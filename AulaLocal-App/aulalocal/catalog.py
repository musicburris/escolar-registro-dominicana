...
MODULES = {
 ...
 F('grado','Grado',required=True),F('seccion','Sección',required=True),F('fecha','Fecha de matrícula','date',True),
 F('estado','Estado','choice',True,('Activo','Retirado','Trasladado','Egresado')),F('notas','Observaciones del expediente','long')]),
 'staff': ('Personal', [F('codigo','Código del personal',required=True),F('nombre','Nombres y apellidos',required=True),
 ...
 F('dia','Día del ciclo',required=True),F('servicio','Servicio','choice',True,('Leche','Pan','Almuerzo')),
 ...
 F('servicio','Servicio','choice',True,('Leche','Pan','Almuerzo')),F('menu','Menú del ciclo','menu_ref',True),
 ...
 F('responsable','Recibido por',required=True),F('incidencias','Incidencias / temperatura / calidad','long'),
...
ACCESS={
 'admin':set(MODULES),'direccion':set(MODULES),'secretaria':{'students','staff','attendance'},
